...
| **AnalysisAgent** | [agents/analysis_agent.py](agents/analysis_agent.py) | 9 charting tools — root cause / service category / duration distributions (pie, bar, stacked, box, line) |
