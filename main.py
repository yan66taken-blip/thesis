...
from tools.plot_servicecategory import plot_service_category_percent
...
def main():
    ...
    agent = create_agent(
        ...
        tools=tools,
        system_prompt=(
            "You are an incident analysis assistant. You have four tools:\n"
            ...
            "Only use a tool when the user's message clearly calls for it. "
